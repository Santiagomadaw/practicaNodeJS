...
const validate = {
    ...
    queryValidator: [
        query('name').notEmpty().optional().isString().withMessage('debe ser una cadena de texto'),
        query('photo').notEmpty().optional().isString().withMessage('debe ser una cadena de texto'),
